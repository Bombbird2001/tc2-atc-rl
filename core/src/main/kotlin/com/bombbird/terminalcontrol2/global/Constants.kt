...
const val LOC_CAP_IAS_CHECK = true
const val MAX_AIRCRAFT_ON_MAP = 15
const val AIRCRAFT_TO_SPAWN = 30
...
const val CHECK_WAKE_CONFLICT = true
const val ENABLE_TRAJECTORY_ALTITUDE_MASKING = false
const val TRAJECTORY_CHECK_MAX_TIME_S = 90
const val CLEARANCE_CHANGE_PENALTY = 0.03f
const val PER_STEP_PENALTY = 0.02f
const val LOC_PROX_PENALTY = 0.04f
const val HIGH_APP_SPD_PENALTY = 0.05f
const val RL_HORIZONTAL_SEP_MINIMA_MULT = 1.15f
const val RL_WAKE_SEP_MINIMA_MARGIN = 0.8f
const val MAX_SPAWN_DIST_NM = 60
const val MIN_SPAWN_DIST_NM = 5
const val DIST_SCORE_A = -0.8f
const val DIST_SCORE_B = 4
const val DIST_SCORE_C = 0.02f
const val DIST_SCORE_M = 1
const val DIST_SCORE_N = 1.5f
